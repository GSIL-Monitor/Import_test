...
public class JimdbCacheProvider implements CachingProvider {
    private static final Object _lock = new Object();
    private static JimdbCacheManager storedCacheManager = null;
    ...
    public CacheManager getCacheManager() {
        if (storedCacheManager == null) {
            synchronized (_lock) {
                if (storedCacheManager == null) {
                    storedCacheManager = new JimdbCacheManager(this);
                }
            }
        }
