...
public class LevelIICacheProvider implements CachingProvider {
    private static final Object _lock = new Object();
    private static LevelIICacheManager storedCacheManager = null;
    ...
    public CacheManager getCacheManager() {
        if (storedCacheManager == null) {
            synchronized (_lock) {
                if (storedCacheManager == null) {
                    storedCacheManager = new LevelIICacheManager(this);
                }
            }
        }
