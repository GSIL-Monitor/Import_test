...
public class BloomFilter<E> implements Serializable {
    ...
    public BloomFilter(double falsePositiveProbability, int expectedNumberOfElements) {
        ...
        LOGGER.debug("falsePositiveProbability = " + falsePositiveProbability);
        LOGGER.debug("expectedNumberOfElements = " + expectedNumberOfElements);
        LOGGER.debug("c:" + Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))) / Math.log(2));
        LOGGER.debug("n:" + expectedNumberOfElements);
        LOGGER.debug("k:" + (int) Math.ceil(-(Math.log(falsePositiveProbability) / Math.log(2))));
