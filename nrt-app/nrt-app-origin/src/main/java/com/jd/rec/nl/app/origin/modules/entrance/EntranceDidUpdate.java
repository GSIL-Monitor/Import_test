 ...
 * @date 2018/12/1
 */
public class EntranceDidUpdate extends PoolToCid3ToSKU {

    private String name = "entrance_did";

    private String didToSkuModelName = "nl_entrance_recalled_did";

    Map<Long, List<Integer>> blackChannelToCid3s = new HashMap<>();

    public EntranceDidUpdate() {
    }

    @Inject
    public EntranceDidUpdate(@Named("blackCid3sFor219") List<Integer> blackCid3sFor219) {
