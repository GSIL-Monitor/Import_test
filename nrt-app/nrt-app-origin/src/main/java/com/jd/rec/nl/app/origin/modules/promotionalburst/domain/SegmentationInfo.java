...
public class SegmentationInfo implements Serializable {
    ...
    public SegmentationInfo(int topSize, List<String> userDimensionDefine, DimensionValue userDimensionValue,
                            List<String> itemDimensionDefine, DimensionValue itemDimensionValue, String keyPostfix) {
        ...
        this.keyPostfix = keyPostfix == null ? "" : keyPostfix;
    }
    ...
    public String toString() {
        ...
        if (keys.length() == 0) {
            ...
            out = keys.substring(0, keys.length() - 1).concat(String.valueOf(DimensionValue.VALUE_SEP))
                    .concat(values.substring(0, values.length() - 1));
        }
        if (!this.keyPostfix.isEmpty()) {
            out = out.concat(this.keyPostfix);
        }
        return out;
    }
}
