 ...
 * @date 2018/9/28
 */
public class DongGardenItemClickParse implements MessageParse<Message<String>> {

    private static final String TOPIC = "appsdk_click.AllGardens_Main_Product";
    ...
    public ImporterContext parse(Message<String> message) throws Exception {
        ...
        importerContext.setBehaviorField(BehaviorField.CLICK);
