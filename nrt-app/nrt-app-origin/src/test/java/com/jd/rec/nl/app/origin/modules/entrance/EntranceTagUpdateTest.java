...
public class EntranceTagUpdateTest {
    static EntranceTagUpdate entranceUpdate;
    ...
    public void prepareDebug() {
        ...
        experimentVersionHolder.register(new EntranceTagUpdate());
        experimentVersionHolder.build();
        entranceUpdate = (EntranceTagUpdate) experimentVersionHolder.getNodeAllBranches("entrance_tag").get(0);
...
//        input.setSkuExtraProfiles(skuExtraProfiles);
        ...
        miscInfo.put("r_sku_to_theme", skuPW);
