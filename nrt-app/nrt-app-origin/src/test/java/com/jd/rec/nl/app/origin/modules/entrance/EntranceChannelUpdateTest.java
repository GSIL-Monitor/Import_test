...
public class EntranceChannelUpdateTest {
    ...
    public void prepareDebug() {
        ...
        entranceUpdate = (EntranceDidUpdate) experimentVersionHolder.getNodeAllBranches("entrance_old").get(0);
    ...
    public MapperContext prepareContext(String uid, long sku, long time, long relSku, long simSku) {
        ...
        miscInfo.put("r_contentid_to_chnlid", skuPW);
